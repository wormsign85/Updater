...
$sql_select = "SELECT szla_id,keszlet_new FROM wormsignh_wormsign_hu.tps_webshop WHERE keszlet_new!=keszlet_unas AND(gigatel_id!='' OR haffner_id!='') ";

//WHERE keszlet_new!=keszlet_unas
...
echo $stock_s->asXML();
file_put_contents('stocks_unas_tok.xml',$stock_s->asXML());
try {
