...
$sql = " UPDATE products SET categories=:categories,description=:description,basic_price=:basic_price,"
        . " price=:price,multiplier_price=:multiplier_price,"
        . " image_url=:image_url,compatible_devices=:compatible_devices,"
        . " related_products=:related_products,all_category=:all_category,youtube=:youtube WHERE sku=:sku";
