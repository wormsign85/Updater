...
//            . $row['id'] . '&amp;text=');
//    $errorurl = $customer->addChild('errorurl', 'http://update.wormsign.hu/customers/symbol/customer_error.php?errorid='
//            . $row['id'] . '&amp;text=');
...
//    $housenumber = $customer->addChild('housenumber', $row['housenumber']);
...
$sql1 = " UPDATE wormsignh_atvetel.customer SET downloaded='1' ";
