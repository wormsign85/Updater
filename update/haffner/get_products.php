...
*/
//$xml1 = file_get_contents ('products.xml');
...
print_r($xml);
    ...
    $sql = "INSERT IGNORE INTO products (sku,name,id,"

            . " categories,manufacturer,basic_price,price,multiplier_price,"

            . " tax_rate,short_description,image_url,compatible_devices,related_products,all_category,publish)"
            . " VALUES (:sku,:name,:id,"
...
mysql_query("UPDATE wormsignh_haffner.sajat_termekek p
            INNER JOIN wormsignh_wormtest.tps_webshop w ON(p.sku=w.cameron_sku)
            SET p.szla_id=w.xrefid",
 $conn);