...
$map = array();
$result = ata_mysql_query("SELECT sku, xref_new FROM wormsignh_haffner.haffner_xref WHERE xref_new LIKE '%Samsung Galaxy S3 I9300%'");
while ($row = mysql_fetch_assoc($result)) {
...
$csv = implode("\n", array_keys($csv));
file_put_contents('galaxy_s3.csv', $csv);
