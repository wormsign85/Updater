...
//    $projects = $orders->addChild('Projects');
//    $project = $projects->addChild('Project Id="1234"');
//    $name = $project->addChild('OrderNumber', $customer_username);
}
...
get_orders_unas($client, $config['realpower'], $config_db);
get_orders_unas($client, $config['felujitas'], $config_db);
