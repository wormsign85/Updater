...
$sql_select = " SELECT id, xrefid,keszlet, keszlet_ws FROM wormsignh_wormsign_hu.tps_webshop_new "
...
$sql_update1 = " UPDATE wormsignh_wormsign_hu.tps_webshop_new "
...
echo $stock_s->asXML();
file_put_contents('stocks_unas_ac1.xml',$stock_s->asXML());
try {
